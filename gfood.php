...
<html lang="en">
  <head>
    ...
    <title>GFood Kantin Idola</title>
    <!-- Arif R -->
  ...
  <!-- menu -->
    <section id="menu">
     ...
     <div class="col-12 col-lg-4 mb-4">
      ...
      <img src="assets/img/menu/tea.webp" class="card-img-top" alt="bakso">
       <div class="card-body">
        <h5 class="card-title">Es Teh Solo</h5>
      ...
      <div class="card-body">
        <h5 class="card-title">Jas Jeyuk</h5>
    ...
    <section id="contact">
      ...
      <div class="col-10 col-md-4">
        ...
        <p> <i class="fa-solid fa-location-dot"></i> Kav.Agraria Karawaci Tangerang </p>
        <h2 class="mb-3">Contact</h2>
        <p><i class="fa-solid fa-user"></i> Arif Rahmanto</p>
        <h2 class="mb-3">Telp</h2>
        <p><i class="fa-brands fa-square-whatsapp"></i> 08811294656</p>
        <h2 class="mb-3">Email</h2>
        <p><i class="fa-solid fa-envelope"></i> arifrahmanto667@gmail.com</p>
    ...
    <div class="container">
      <footer class="py-3 my-4">
        ...
        <p class="text-center text-body-secondary">&copy; Cafe Global 2024</p>
      </footer>
    </div>
